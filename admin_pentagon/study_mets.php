...
font-size: 16px;"> <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
 ...
 <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" required placeholder="Enter the Link" name="link">
  </div>
  <br>
   <div class="form-group">
...
if($_POST)
{
  $name=$_POST['title'];
  $link=$_POST['link'];
$qr="INSERT INTO `study_mets`(`title`,`link`) VALUES('$name','$link')";
    ...
    while($row=mysqli_fetch_array($done1))
      {
         ...
         <td><a href="study_mets_del.php?id=<?php echo $row[0]; ?>">Delete</a></td>
         </tr>
          <?php           
      }
      ?>
