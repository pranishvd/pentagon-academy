...
if($_POST)
{
  $course=$_POST['course'];
  $name=$_POST['subject'];
$qr="INSERT INTO `subjects`(`subject_name`,`course_name`) VALUES('$name','$course')";
...
<table class="table table-condensed">
    ...
    $qry1="SELECT * FROM `subjects`";
    $done1=mysqli_query($con,$qry1)or die("Could not Connect My Sqli_DB");
    while($row=mysqli_fetch_array($done1))
      {
          echo "<tr class='info' style='text-align: center; vertical-align: middle;' ><td>".$row[1]."</td><td>".$row[2]."</td>";?>
