...
font-size: 16px;"> <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="Enter the Course Name" name="course">
  </div>
  <br>
   <div class="form-group">
...
{
  $name=$_POST['course'];
$qr="INSERT INTO `course`(`name`) VALUES('$name')";
    ...
    while($row=mysqli_fetch_array($done1))
      {
         ...
         <td><a href="course_del.php?id=<?php echo $row[0]; ?>">Delete</a></td>
         </tr>
          <?php           
      }
      ?>
