...
font-size: 16px;"> <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
 ...
 <div class="form-group">
    ...
    <textarea name="content" placeholder="Notification" style="overflow:auto;resize:none" required class="form-control" rows=6></textarea>
  </div>
...
$qr="INSERT INTO `notification`(`content`) VALUES('$name')";
...
<table class="table table-condensed">
    <thead><tr class="danger" ><th style="text-align: center; vertical-align: middle;">Contents</th>
      <th></th></tr></thead>
    <tbody>
      <?php 
    ...
    while($row=mysqli_fetch_array($done1))
      {
          echo "<tr class='info' style='text-align: center; vertical-align: middle;' ><td>".$row[1]."</td>";?>
         <td><a href="noti_del.php?id=<?php echo $row[0]; ?>">Delete</a></td>
         </tr>
          <?php           
      }
      ?>
