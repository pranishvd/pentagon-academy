...
font-size: 16px;"> <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="Enter the Exam Name" name="exam">
  </div>
  <br>
   <div class="form-group">
...
{
  $name=$_POST['exam'];
$qr="INSERT INTO `exam_type`(`exam_name`) VALUES('$name')";
    ...
    while($row=mysqli_fetch_array($done1))
      {
         ...
         <td><a href="exam_del.php?id=<?php echo $row[0]; ?>">Delete</a></td>
         </tr>
          <?php           
      }
      ?>
